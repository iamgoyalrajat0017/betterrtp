...
import com.booksaw.betterTeams.commands.teama.admin.AdminBankTeama;
import com.booksaw.betterTeams.commands.teama.admin.AdminInfoTeama;
import com.booksaw.betterTeams.commands.teama.admin.AdminListTeama;
import com.booksaw.betterTeams.commands.teama.admin.AdminSearchTeama;
...
public class Main extends JavaPlugin {
	...
	public void setupCommands() {
		...
		ParentCommand teamaAdminCommand = new ParentCommand("admin");
		teamaAdminCommand.addSubCommands(new AdminListTeama(), new AdminInfoTeama(), new AdminBankTeama(),
				new AdminSearchTeama());
		teamaCommand.addSubCommand(teamaAdminCommand);
		...
		if (econ != null) {
			...
			ParentCommand teamBankCommand = new ParentCommand("bank");
			teamBankCommand.addSubCommand(new BankTransferCommand(teamBankCommand));
			teamCommand.addSubCommand(teamBankCommand);
		}
