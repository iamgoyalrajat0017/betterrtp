...
public class TagCommand extends TeamSubCommand {
	...
	public CommandResponse onCommand(TeamPlayer player, String label, String[] args, Team team) {
		...
		CommandResponse costCheck = TeamUtil.verifyCanAffordCost(player.getOnlinePlayer().orElse(null),
				"team-tag-change", "tag.insufficientFunds");
		if (costCheck != null) {
			return costCheck;
		}

		team.setTag(args[0]);
		TeamUtil.chargeCost(player.getOnlinePlayer().orElse(null), "team-tag-change");
