...
public class ColorCommand extends TeamSubCommand {
	...
	public CommandResponse onCommand(TeamPlayer teamPlayer, String label, String[] args, Team team) {
		...
		CommandResponse costCheck = TeamUtil.verifyCanAffordCost(teamPlayer.getOnlinePlayer().orElse(null),
				"team-color-change", "color.insufficientFunds");
		if (costCheck != null) {
			return costCheck;
		}

		team.setColor(color);
		TeamUtil.chargeCost(teamPlayer.getOnlinePlayer().orElse(null), "team-color-change");
