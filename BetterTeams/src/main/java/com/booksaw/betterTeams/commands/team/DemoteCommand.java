...
public class DemoteCommand extends TeamSubCommand {
	...
	public CommandResponse onCommand(TeamPlayer teamPlayer, String label, String[] args, Team team) {
		...
		if (demotePlayer.getRank() == PlayerRank.OWNER && team.isMaxOwners()) {
			return new CommandResponse("demote.maxOwners");
		}

		if (demotePlayer.getRank() == PlayerRank.CO_OWNER && team.isMaxAdmins()) {
